  ...
  <div>
    ...
    <div>
      ...
      <div class="card">
        ...
        <!-- <img :src="arr.img" alt=""> -->
        <span>{{arr.teacher_names}}</span>
        <p>{{arr.teacher_schools}}</p>
        <p class="ppp">{{arr.teacher_qualifieds}}</p>
        <p class="ooo">{{arr.Teacher_subjects}}</p>
        <p class="iii">{{arr.teacher_courser_times}}</p>
      </div>
      ...
      <div class="writings">
        ...
        <h3>{{arr.annotations}}</h3>
        <h4>{{arr.names}}</h4>
        <h5>{{arr.Special_class_teachers}}</h5>
        <div class="aaa">
          <span>{{arr.contents}}</span>
        </div>
      ...
      <div class="longitudinal">
        <van-swipe :show-indicators="false" style="height: 200px;" vertical>
          ...
          <van-swipe-item>
            <img :src="arr.longitudinalss" alt />
          </van-swipe-item>
        </van-swipe>
      </div>
